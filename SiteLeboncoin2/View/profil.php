                    ...
                    <div class="col-lg-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input class='btn btn-success' name='bout_avatar' type='submit' value='Modifier avatar'>
                                </form>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                        <h2 class='fw-bold mb-2'>Modifier mes informations:</h2>
                                            ...
                                            <div class='mb-4'>
                                                ...
                                                <input class='btn btn-success' name='bout_info' type='submit' value='Enregistrer mes informations'>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h2 class='fw-bold mb-2'>Modifier mon mot de passe:</h2>
                                    ...
                                    <input class='btn btn-success' name='bout_mdp' type='submit' value='Enregistrer le nouveau mot de passe'>
