...
<head>
    ...
    <link rel="stylesheet" href="../asset/template/assets/vendors/materialdesignicons.min.css">
    <link rel="stylesheet" href="../asset/template/assets/vendors/vendor.bundle.base.css">
    <link rel="stylesheet" href="../asset/template/assets/css/demo_3/style.css">
    <link rel="shortcut icon" href="../image/logomarwa.png" />
                ...
                <div class="col-lg-6 d-flex align-items-center justify-content-center">
                    <div class="auth-form-transparent text-left p-3">
                        <div class="brand-logo text-center">
                            <img src="../image/logomarwa.png" alt="logo">
                        </div>
                        <?php
                        ...
                        <span class="input-group-text bg-transparent border-right-0">
                          <i class="mdi mdi-account-outline text-primary"></i>
                            ...
                            <div class="my-3 text-center">
                                <input type="submit" name="submit" class="btn btn-outline-danger btn-lg btn-block" value="Connexion">
                            </div>
